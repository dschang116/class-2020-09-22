...
- acknowledge we can not observe outcomes for every undergraduate;
- take samples that represent populations we may be interested in
- ask why is someone interested in drop in undergraduate enrollment


After we have a model, Temperance suggests we should:
- acknowledge there are small variables that affect circumstances that are unknowable
- acknowledge students within the sample may not be entirely representative of the student body as a whole
...
```{r}
left_join(sep_old, sep_new, by = "id", suffix = c("_new", "_old")) %>%
